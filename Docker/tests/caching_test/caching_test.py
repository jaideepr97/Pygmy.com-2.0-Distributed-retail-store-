...
if __name__ == '__main__':
    ...
    file.close()
    operations = ['lookup/2', 'lookup/2', 'lookup/2', 'lookup/2', 'search/distributed%20systems', 'search/distributed%20systems', 'lookup/2', 'search/distributed%20systems', 'lookup/2', 'lookup/2']
