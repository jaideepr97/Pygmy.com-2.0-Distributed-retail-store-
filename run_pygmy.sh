...
ssh ${user}@elnux2.cs.umass.edu "sh -c 'cd cs677/lab-3-lab-3-rao-gupta/src; nohup chmod +x run_order_B.sh; nohup ./run_order_B.sh > /dev/null 2>&1 &'"
ssh ${user}@elnux3.cs.umass.edu "sh -c 'cd cs677/lab-3-lab-3-rao-gupta/src; echo "$user" > username.txt &'"
ssh ${user}@elnux3.cs.umass.edu "sh -c 'cd cs677/lab-3-lab-3-rao-gupta/src; nohup chmod +x run_front_end.sh; nohup ./run_front_end.sh > /dev/null 2>&1 &'"
